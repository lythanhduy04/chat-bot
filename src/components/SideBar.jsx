  ...
  return (
    <div className="bg-primaryBg-sidebar w-[280px] h-screen text-white p-8">
      <button className="flex ml-auto xl:hidden " onClick={onToggle}>
        <img src={IconMenu} alt="icon menu" className="w-10 h-10" />
      </button>
      <div className="mt-20 ">
        <button
            ...
            {data.map((chat) => (
              ...
              >
                <div className="flex items-center space-x-4">
                  <img src={IconChat} alt="icon chat" className="w-8 h-8" />
                  <p>{chat.title}</p>
                </div>
                <button
                  onClick={(e) => {
                ...
                >
                  <img src={IconTrash} alt="icon trash" className="w-5 h-5" />
                </button>
              </Link>
            ))}
          </div>
